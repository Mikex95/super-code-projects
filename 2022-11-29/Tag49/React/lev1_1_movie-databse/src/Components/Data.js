...
const Data = () => {
    ...
    const [sort, setSort] = useState(database);


    const numAscendingRate = [...database].sort((a, b) => b.rate - a.rate);
  
    const numAscending = [...database].sort((a, b) => a.year - b.year);

    const numDescending = [...database].sort((a, b) => b.year - a.year);
    
    const strAscending = [...database].sort((a, b) =>
    a.title > b.title ? 1 : -1,
    );

    const strDescending = [...database].sort((a, b) =>
    a.title > b.title ? -1 : 1,
    );
        ...
        return (
            <section>
            <div>
                <button onClick={() => setSort(numAscending)}>Sort by Date Ascending</button>
                <button onClick={() => setSort(numDescending)}>Sort by Date Descending</button>
                <button onClick={() => setSort(numAscendingRate)}>Best Rate</button>
                <button onClick={() => setSort(strAscending)}>A-Z</button> 
                <button onClick={() => setSort(strDescending)}>Z-A</button>
            </div>
